 ...
 */
import { scrypt as scryptOld } from "https://deno.land/x/scrypt@v4.4.0/lib/scrypt.ts";
import { scrypt } from "./scrypt.ts";
import { scrypt as scryptNodeRaw } from "node:crypto";
import { scrypt as scryptoRaw } from "https://deno.land/x/scrypto@v4.4.0/main.ts";
