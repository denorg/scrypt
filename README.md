...
```ts
import { hash, verify } from "jsr:@denorg/scrypt@4.3.3";
...
```bash
deno run jsr:@denorg/scrypt@4.3.3/cli hash <password>
deno run jsr:@denorg/scrypt@4.3.3/cli verify <password> <hash>
```

You can also install it globally using the following:

```bash
deno install -n scrypt jsr:@denorg/scrypt@4.3.3/cli
```
